...
export const useTeamMember = (initialTeamMemberId?: string) => {
  ...
  // ==============================================
  // UPDATE ACTIONS (using single updateTeamMember method)
  // ==============================================
  const updateTeamMemberField = useCallback(async (
    ...
    try {
      ...
      const updateData: Partial<UpdateTeamMemberData> = { [field]: value }
  ...
  const updateTeamMemberRates = useCallback(async (
    ...
    const updateData: Partial<UpdateTeamMemberData> = {}
