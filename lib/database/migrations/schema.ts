import { pgTable, index, unique, check, uuid, varchar, text, timestamp, integer, boolean, foreignKey, jsonb, inet, numeric, date, point, time } from "drizzle-orm/pg-core"
...
export const timeEntries = pgTable("time_entries", {
	...
	index("idx_time_entries_task_id").using("btree", table.taskId.asc().nullsLast().op("uuid_ops")),
...
export const auditLogs = pgTable("audit_logs", {
	...
	index("idx_audit_resource").using("btree", table.resourceType.asc().nullsLast().op("uuid_ops"), table.resourceId.asc().nullsLast().op("text_ops")),
...
export const projectMembers = pgTable("project_members", {
	...
	index("idx_project_members_company_status").using("btree", table.companyId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("uuid_ops")),
	...
	index("idx_project_members_project_status").using("btree", table.projectId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("text_ops")),
	...
	index("idx_project_members_user_status").using("btree", table.userId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const projects = pgTable("projects", {
	...
	index("idx_projects_company_priority").using("btree", table.companyId.asc().nullsLast().op("uuid_ops"), table.priority.asc().nullsLast().op("uuid_ops")),
	index("idx_projects_company_status").using("btree", table.companyId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("text_ops")),
	...
	index("idx_projects_status_progress").using("btree", table.status.asc().nullsLast().op("int4_ops"), table.progress.asc().nullsLast().op("text_ops")),
	...
	unique("projects_project_number_unique").on(table.projectNumber),
...
export const scheduleProjects = pgTable("schedule_projects", {
	...
	index("idx_schedule_projects_project_status").using("btree", table.projectId.asc().nullsLast().op("text_ops"), table.status.asc().nullsLast().op("uuid_ops")),
...
export const punchlistItems = pgTable("punchlist_items", {
	...
	assignedProjectMemberId: uuid("assigned_project_member_id"),
	...
	index("idx_punchlist_items_assigned_member_status").using("btree", table.assignedProjectMemberId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("text_ops")),
	index("idx_punchlist_items_assigned_project_member_id").using("btree", table.assignedProjectMemberId.asc().nullsLast().op("uuid_ops")),
	index("idx_punchlist_items_company_id").using("btree", table.companyId.asc().nullsLast().op("uuid_ops")),
	index("idx_punchlist_items_company_status").using("btree", table.companyId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("uuid_ops")),
	...
	index("idx_punchlist_items_project_status").using("btree", table.projectId.asc().nullsLast().op("uuid_ops"), table.status.asc().nullsLast().op("text_ops")),
	...
	foreignKey({
			columns: [table.assignedProjectMemberId],
			foreignColumns: [projectMembers.id],
			name: "punchlist_items_assigned_project_member_id_project_members_id_f"
		}).onDelete("set null"),
	foreignKey({
			columns: [table.companyId],
			foreignColumns: [companies.id],
