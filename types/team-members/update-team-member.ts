...
export interface UpdateTeamMemberData {
    ...
    // PROJECT ASSIGNMENT FIELDS (ADD THESE)
...
export const updateTeamMemberSchema = z.object({
    ...
    // PROJECT ASSIGNMENT FIELDS (ADD THESE)
    assignToProject: z.boolean()
        .optional(),

    projectId: z.string()
        .min(1, 'Project ID is required when assigning to project')
        .optional(),
    ...
    projectNotes: z.string()
        .max(500, 'Project notes must be less than 500 characters')
        .optional(),

    assignmentStatus: z.enum(['active', 'inactive'])
        .optional(),
})
...
export function getDefaultUpdateTeamMemberFormData(): UpdateTeamMemberFormData {
    return {
        ...
        // PROJECT ASSIGNMENT DEFAULTS (ADD THESE)
